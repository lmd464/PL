...
# 5 "week11/hw/fp-style/parser/parser.mly"
       (int)
# 17 "week11/hw/fp-style/parser/parser.ml"
  )
    | LSPAREN
    | KW_TRUE
    | KW_THEN
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 31 "week11/hw/fp-style/parser/parser.ml"
  )
    | EOF
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 150 "week11/hw/fp-style/parser/parser.ml"
        ))), _, (_2 : (string list))) = _menhir_stack in
        let _v : (string list) = 
# 53 "week11/hw/fp-style/parser/parser.mly"
               ( _1 :: _2 )
# 155 "week11/hw/fp-style/parser/parser.ml"
         in
...
# 368 "week11/hw/fp-style/parser/parser.ml"
             in
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 451 "week11/hw/fp-style/parser/parser.ml"
...
# 21 "week11/hw/fp-style/parser/parser.mly"
                                              ( Ast.LetIn (_2, _4, _6) )
# 459 "week11/hw/fp-style/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 542 "week11/hw/fp-style/parser/parser.ml"
...
# 557 "week11/hw/fp-style/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 605 "week11/hw/fp-style/parser/parser.ml"
             in
...
# 37 "week11/hw/fp-style/parser/parser.mly"
                         ( _2 )
# 644 "week11/hw/fp-style/parser/parser.ml"
             in
            _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 17 "week11/hw/fp-style/parser/parser.mly"
           ( Ast.Prog _1 )
# 665 "week11/hw/fp-style/parser/parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 697 "week11/hw/fp-style/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 711 "week11/hw/fp-style/parser/parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 52 "week11/hw/fp-style/parser/parser.mly"
       ( [_1] )
# 716 "week11/hw/fp-style/parser/parser.ml"
         in
        _menhir_goto_id_list _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 30 "week11/hw/fp-style/parser/parser.mly"
         ( _1 )
# 734 "week11/hw/fp-style/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState12 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 32 "week11/hw/fp-style/parser/parser.mly"
                      ( Ast.Add (_1, _3) )
# 746 "week11/hw/fp-style/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState14 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 33 "week11/hw/fp-style/parser/parser.mly"
                       ( Ast.Sub (_1, _3) )
# 758 "week11/hw/fp-style/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState16 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 34 "week11/hw/fp-style/parser/parser.mly"
                    ( Ast.Lt (_1, _3) )
# 770 "week11/hw/fp-style/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
...
# 31 "week11/hw/fp-style/parser/parser.mly"
              ( Ast.App (_1, _2) )
# 781 "week11/hw/fp-style/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()
...
# 5 "week11/hw/fp-style/parser/parser.mly"
       (int)
# 897 "week11/hw/fp-style/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 5 "week11/hw/fp-style/parser/parser.mly"
       (int)
# 905 "week11/hw/fp-style/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 38 "week11/hw/fp-style/parser/parser.mly"
           ( Ast.Num _1 )
# 910 "week11/hw/fp-style/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
# 960 "week11/hw/fp-style/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
# 1047 "week11/hw/fp-style/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 1054 "week11/hw/fp-style/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 4 "week11/hw/fp-style/parser/parser.mly"
       (string)
# 1062 "week11/hw/fp-style/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 39 "week11/hw/fp-style/parser/parser.mly"
       ( Ast.Id _1 )
# 1067 "week11/hw/fp-style/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
# 1117 "week11/hw/fp-style/parser/parser.ml"
