...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | OP_EQ
    | NUMBER of (
# 5 "w11/practice/vanilla/parser/parser.mly"
       (int)
# 17 "w11/practice/vanilla/parser/parser.ml"
  )
    | LSPAREN
    | KW_TRUE
    | KW_THEN
    ...
    | KW_ELSE
    | ID of (
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 31 "w11/practice/vanilla/parser/parser.ml"
  )
    | EOF
...
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 150 "w11/practice/vanilla/parser/parser.ml"
        ))), _, (_2 : (string list))) = _menhir_stack in
        let _v : (string list) = 
# 53 "w11/practice/vanilla/parser/parser.mly"
               ( _1 :: _2 )
# 155 "w11/practice/vanilla/parser/parser.ml"
         in
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState20 ->
        ...
        | EOF | KW_ELSE | KW_IN | KW_THEN | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 20 "w11/practice/vanilla/parser/parser.mly"
                                                   ( Ast.Cond (_2, _4, _6) )
# 368 "w11/practice/vanilla/parser/parser.ml"
             in
...
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 451 "w11/practice/vanilla/parser/parser.ml"
            ))), _), _, (_4 : (Ast.expr))), _), _, (_6 : (Ast.expr))) = _menhir_stack in
            let _5 = () in
            let _3 = () in
            let _1 = () in
            let _v : (Ast.expr) = 
# 21 "w11/practice/vanilla/parser/parser.mly"
                                              ( Ast.LetIn (_2, _4, _6) )
# 459 "w11/practice/vanilla/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 542 "w11/practice/vanilla/parser/parser.ml"
            ))), _, (_3 : (string list))), _, (_5 : (Ast.expr))), _), _, (_7 : (Ast.expr))) = _menhir_stack in
            let _6 = () in
            let _4 = () in
            let _1 = () in
            let _v : (Ast.expr) = 
# 22 "w11/practice/vanilla/parser/parser.mly"
                                                      ( 
      let rec f = function
...
# 557 "w11/practice/vanilla/parser/parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState35 ->
        ...
        | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 42 "w11/practice/vanilla/parser/parser.mly"
                                                  ( 
      let rec f = function
        | [] -> failwith "[Err] Wrong grammar"
        | [x] -> Ast.Fun (x, _5)
...
# 605 "w11/practice/vanilla/parser/parser.ml"
             in
    ...
    | MenhirState2 ->
        ...
        | RSPAREN ->
            ...
            let _1 = () in
            let _v : (Ast.expr) = 
# 37 "w11/practice/vanilla/parser/parser.mly"
                         ( _2 )
# 644 "w11/practice/vanilla/parser/parser.ml"
             in
            _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            ...
            let _2 = () in
            let _v : (Ast.fvae) = 
# 17 "w11/practice/vanilla/parser/parser.mly"
           ( Ast.Prog _1 )
# 665 "w11/practice/vanilla/parser/parser.ml"
             in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 697 "w11/practice/vanilla/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
...
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 711 "w11/practice/vanilla/parser/parser.ml"
        ))) = _menhir_stack in
        let _v : (string list) = 
# 52 "w11/practice/vanilla/parser/parser.mly"
       ( [_1] )
# 716 "w11/practice/vanilla/parser/parser.ml"
         in
        _menhir_goto_id_list _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
and _menhir_goto_term : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expr) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState0 | MenhirState2 | MenhirState35 | MenhirState31 | MenhirState29 | MenhirState24 | MenhirState6 | MenhirState20 | MenhirState18 | MenhirState7 ->
        ...
        let _v : (Ast.expr) = 
# 30 "w11/practice/vanilla/parser/parser.mly"
         ( _1 )
# 734 "w11/practice/vanilla/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState12 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 32 "w11/practice/vanilla/parser/parser.mly"
                      ( Ast.Add (_1, _3) )
# 746 "w11/practice/vanilla/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState14 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 33 "w11/practice/vanilla/parser/parser.mly"
                       ( Ast.Sub (_1, _3) )
# 758 "w11/practice/vanilla/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState16 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _2 = () in
        let _v : (Ast.expr) = 
# 34 "w11/practice/vanilla/parser/parser.mly"
                    ( Ast.Lt (_1, _3) )
# 770 "w11/practice/vanilla/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | MenhirState41 | MenhirState38 | MenhirState36 | MenhirState30 | MenhirState32 | MenhirState23 | MenhirState25 | MenhirState11 | MenhirState19 | MenhirState21 ->
        ...
        let (_menhir_stack, _menhir_s, (_1 : (Ast.expr))) = _menhir_stack in
        let _v : (Ast.expr) = 
# 31 "w11/practice/vanilla/parser/parser.mly"
              ( Ast.App (_1, _2) )
# 781 "w11/practice/vanilla/parser/parser.ml"
         in
        _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()
...
# 5 "w11/practice/vanilla/parser/parser.mly"
       (int)
# 897 "w11/practice/vanilla/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 5 "w11/practice/vanilla/parser/parser.mly"
       (int)
# 905 "w11/practice/vanilla/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 38 "w11/practice/vanilla/parser/parser.mly"
           ( Ast.Num _1 )
# 910 "w11/practice/vanilla/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run3 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    let _1 = () in
    let _v : (Ast.expr) = 
# 40 "w11/practice/vanilla/parser/parser.mly"
            ( Ast.Bool true )
# 960 "w11/practice/vanilla/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run8 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    let _1 = () in
    let _v : (Ast.expr) = 
# 41 "w11/practice/vanilla/parser/parser.mly"
             ( Ast.Bool false )
# 1047 "w11/practice/vanilla/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 1054 "w11/practice/vanilla/parser/parser.ml"
) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_env = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
...
# 4 "w11/practice/vanilla/parser/parser.mly"
       (string)
# 1062 "w11/practice/vanilla/parser/parser.ml"
    )) = _v in
    let _v : (Ast.expr) = 
# 39 "w11/practice/vanilla/parser/parser.mly"
       ( Ast.Id _1 )
# 1067 "w11/practice/vanilla/parser/parser.ml"
     in
    _menhir_goto_term _menhir_env _menhir_stack _menhir_s _v
...
# 1117 "w11/practice/vanilla/parser/parser.ml"
